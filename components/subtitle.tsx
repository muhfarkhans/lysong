    ...
    <div className="relative w-full h-full">
      <div className="flex flex-col justify-center items-center space-y-2 w-full h-full -mt-10">
        ...
        {/* <div className="relative">
          <div className="h-10 w-full absolute top-0 bg-gradient-to-b from-white to-transparent"></div>
          <div className="h-10 w-full absolute bottom-0 bg-gradient-to-t from-white to-transparent"></div>
          <div
            id="box"
            className="h-[150px] w-full p-4 rounded overflow-scroll no-scrollbar"
          >
            {listSubtitle.map((subtitle, index) => {
              let active = "";
              // if (listSubtitle[index + 1]) {
              //   if (subtitle.idLyric != listSubtitle[index + 1].idLyric) {
              //     active = "";
              //   }
              // }
